...
import { getDecodedAccessToken } from '@/src/utils/getDecodedAccessToken';
import { MyJwtPayload } from '@/src/types/jwt/jwt.type';

export default async function HomePage() {
  const decodedAccesstoken = await getDecodedAccessToken() as MyJwtPayload;
